...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->butBack->FlatStyle = System::Windows::Forms::FlatStyle::Popup;
			 ...
			 String^ MovieData;
			 String^ MovieTime;
			 List<int>^ seatsReserved = gcnew List<int>(); // lista ktora trzyma zarezerowane miejsca
			 int fullPrice = 0; // cena calkowita za wszystkie miejsca
